  ...
  <div>
    ...
    <div class="collapse" id="custom-color">
      <div class="form-group d-flex justify-content-between align-items-center">
        <label for="custom-primary-color">Custom Color</label>
...
const updateRadio = (value) => {
  const selectedColor = defaultColors.find((item) => item.value === value)
  settingStore.updateThemeColor(selectedColor)
}
...
const resetColor = () => {
  ...
  settingStore.updateThemeColor(defaultColor)
}

// Debounced color update for custom colors
const batterFun = _.debounce((obj) => {
  settingStore.updateThemeColor(obj)
}, 300)
